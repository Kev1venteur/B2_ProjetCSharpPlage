...
namespace ProjetB2CSharpPlage.DAL
{
    class UtilisateurDAL
    {
        ...
        public static ObservableCollection<UtilisateurDAO> selectUtilisateurs()
        {
            ...
            while (reader.Read())
            {
                UtilisateurDAO p = new UtilisateurDAO(reader.GetInt32(0), reader.GetString(1), reader.GetString(2), reader.GetBoolean(3), reader.GetString(4), reader.GetString(5));
                l.Add(p);
            }
            reader.Close();
            return l;
        ...
        public static UtilisateurDAO getUtilisateur(int idUtilisateur)
        {
            ...
            MySqlDataReader reader = cmd.ExecuteReader();
            reader.Read();
            UtilisateurDAO user = new UtilisateurDAO(reader.GetInt32(0), reader.GetString(1), reader.GetString(2), reader.GetBoolean(3), reader.GetString(4), reader.GetString(5));
            reader.Close();
            return user;
        }
