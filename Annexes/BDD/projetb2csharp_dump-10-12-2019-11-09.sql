...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 10 déc. 2019 à 10:09
...
CREATE TABLE IF NOT EXISTS `commune` (
  ...
  KEY `fk_Commune_Departement1_idx` (`Departement_idDepartement`)
...
INSERT INTO `commune` (`idCommune`, `nom`, `Departement_idDepartement`) VALUES
...
INSERT INTO `plage` (`idPlage`, `nom`, `idCommune`, `ndEspecesDifferentes`, `surface`) VALUES
...
--
ALTER TABLE `commune`
  ADD CONSTRAINT `fk_Commune_Departement1` FOREIGN KEY (`Departement_idDepartement`) REFERENCES `departement` (`idDepartement`) ON DELETE NO ACTION ON UPDATE NO ACTION;
